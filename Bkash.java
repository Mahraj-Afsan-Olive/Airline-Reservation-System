...
public Bkash(){ 
     ...
     ImageIcon img = new ImageIcon("BKash.jpg");
	 ...
	 this.add(backImg);
		...
		l2 = new JLabel("Complete Payment via Bkash");
        ...
        l4=new JLabel("bKash Account Number :"); 
        ...
        bik = new JButton("Payment Details"); 
		bik.addActionListener(this);	
		bik.setBackground(Color.MAGENTA);
        bik.setBounds(550,500,130,20); 
        backImg.add(bik);
...
if(e.getSource()==c)
	...
	else if(e.getSource()==b1)
	{
     ...
     try{
			FileWriter file = new FileWriter("bkash.txt",true); 		
	...
	else if(e.getSource() == bik)
	{
		BikashInfo bikash = new BikashInfo(amount , phnNum, pin, this);
		bikash.setVisible(true);
