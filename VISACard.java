...
public class VISACard extends JFrame implements ActionListener { 
...
public VISACard(){ 
     ...
     ImageIcon img = new ImageIcon("visa.jpg");
	 ...
	 this.add(backImg);
		...
		l2 = new JLabel("Complete Payment via Visa Crad");
	...
	v = new JButton("Payment Details"); 
		v.addActionListener(this);	
		v.setBackground(Color.ORANGE);
        v.setBounds(550,500,170,20); 
        backImg.add(v);
...
if(e.getSource()==c)
	...
	else if(e.getSource()==b1)
	{
     ...
     try{
			FileWriter file = new FileWriter("visacard.txt",true); 		
	...
	{
		VisaInfo visa = new VisaInfo(name , expiry,amount,cvv, this);
